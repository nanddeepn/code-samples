...
export interface IConfigurableTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IConfigurableTabRemoveProps {

}

/**
 * Implementation of Configurable Tab remove page
 */
export class ConfigurableTabRemove  extends TeamsBaseComponent<IConfigurableTabRemoveProps, IConfigurableTabRemoveState> {

# Planet Explorer Bot - `planetExplorerBot`
...
3. Give the bot a handle (ex: `planetExplorerBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://planetexplorerbot.azurewebsites.net/api/messages`

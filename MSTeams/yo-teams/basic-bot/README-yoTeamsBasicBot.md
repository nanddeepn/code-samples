# YoTeamsBasicBot - `yoTeamsBasicBot`
...
3. Give the bot a handle (ex: `yoTeamsBasicBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://yoteamsbasicbot.azurewebsites.net/api/messages`

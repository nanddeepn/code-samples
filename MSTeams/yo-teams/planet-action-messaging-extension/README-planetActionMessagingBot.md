# Planet Action Messaging Bot - `planetActionMessagingBot`
...
3. Give the bot a handle (ex: `planetActionMessagingBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://planetmessagingextension.azurewebsites.net/api/messages`

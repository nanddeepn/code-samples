# CustomerSearch Message Extension Bot - `customerSearchMessageExtensionBot`
...
3. Give the bot a handle (ex: `customerSearchMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://customersearch.azurewebsites.net/api/messages`
